...
class leetspeakWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/leetspeak');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/leetspeak';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"mode":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/leetspeak`);
        }
    }
...
module.exports = leetspeakWrapper;
