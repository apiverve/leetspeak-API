 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/leetspeak?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/leetspeak';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LeetspeakClient] {$message}\n";
        }
    }
}
